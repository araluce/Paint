...
public class RectanguloRedondeado extends Figura{
    ...
    /**
     * Constructor de la clase RectanguloRedondeado
     ...
     */
    public RectanguloRedondeado(Point2D punto, float grosor, Color color, Color fondo, double escala,
        ...
        forma = new RoundRectangle2D.Float(0,0,0,0,25,25);
