...
public class Rectangulo extends Figura{
     ...
     */
    public Rectangulo(Point2D punto, float grosor, Color color, Color fondo, double escala,
        ...
        forma = new Rectangle.Float();
        forma.setFrameFromDiagonal(p1, p1);
    }
    /**
     * Constructor de la clase Rectangulo (a partir de un rectángulo) 
     * @param rec Rectangulo
     */
    public Rectangulo(Rectangle2D rec){
        super(null, 0, Color.BLUE, null, 0, false, false, 0, false);
        forma=rec;
    }
