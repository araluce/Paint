...
public class Punto extends Figura {
     ...
     */
    public Punto(Point2D punto, float grosor, Color color, Color fondo, double escala,
        ...
        p2 = new Point2D.Double(p1.getX()+grosor*10, p1.getY()+grosor*10);
    ...
    public void setPosition(Point2D position) {
        ...
        forma.setFrame(position, new Dimension((int)f.getWidth(), (int)f.getHeight()));
    }
    ...
    public Point2D getPosition() {
        return new Point2D.Double(forma.getX(),forma.getY());
    }
